...
void implBench(int size) {
  ...
  final primePaddedFFT =
      util.isPrime(size) && size > 2 ? fftea.PrimePaddedFFT(size) : null;
  ...
  print(
    '$size, $naiveTimer, $primePaddedTimer, $compositeTimer, $radix2Timer',
  );
}
...
void main() {
  print('Size, NaiveFFT, PrimePaddedFFT, CompositeFFT, Radix2FFT');
